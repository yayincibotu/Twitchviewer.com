            ...
            <div className="mt-8 space-y-6">
              <div className="flex items-start">
                ...
                <div className="ml-3 text-neutral-600">
                  <p>Email us at:</p>
                  <p className="mt-1 font-medium">support@twitchviewer.com</p>
                </div>
              </div>
              <div className="flex items-start">
                <div className="flex-shrink-0">
                ...
                <div className="ml-3 text-neutral-600">
                  <p>Live chat:</p>
                  <p className="mt-1 font-medium">Available 9 AM - 10 PM EST</p>
                </div>
              </div>
              <div className="flex items-start">
                <div className="flex-shrink-0">
                ...
                <div className="ml-3 text-neutral-600">
                  ...
                  <p className="mt-1 font-medium">Less than 12 hours</p>
                </div>
              </div>
            </div>
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <Input
                          ...
                          className="py-3 px-4 block w-full shadow-sm focus:ring-primary focus:border-primary border-neutral-300 rounded-md"
                        />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
